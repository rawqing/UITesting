...
import com.jlc.app.milk_mini.constant.enumerate.Direction;
...
public class CustomViewAction  {
    private static final String TAG = "jlc_" + CustomViewAction.class.getSimpleName();
    ...
    public static ViewAction swipeAsDirection(Direction direction){
        return new SwipeAsDirection(Swipe.FAST, direction, 10, 300, Press.FINGER, false);
    }
    /**
     * 滑动至View可见
     *
...
//    public static ViewAction doSetSomthing(){
//        return new ViewAction() {
//            @Override
//            public Matcher<View> getConstraints() {
//                return isDisplayed();
