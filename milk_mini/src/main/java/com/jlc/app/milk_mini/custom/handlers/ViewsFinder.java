package com.jlc.app.milk_mini.custom.handlers;
...
import static com.jlc.app.milk_mini.custom.actions.CustomViewAction.nothing;
...
public class ViewsFinder {
    ...
    private final String TAG = "jlc_" + this.getClass().getSimpleName();
