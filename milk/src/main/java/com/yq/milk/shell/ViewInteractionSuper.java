...
public class ViewInteractionSuper {
    private static final String TAG = "jcd_AdViewInteraction";
    private static String key = ViewInteractionSuper.class.toString();
    private Element viewElement ;
    private final ViewInteraction viewInteraction;


    public ViewInteractionSuper(Element viewElement){
        this.viewElement = viewElement;
        this.viewInteraction = getViewInteraction(viewElement);
    }

    public ViewInteractionSuper(ViewInteraction viewInteraction) {
     ...
     * @return
     */
    public ViewInteractionSuper perform(final int times , final ViewAction... viewActions) {
    ...
    public ViewInteractionSuper perform(final ViewAction... viewActions) {
        return this.perform(5 ,viewActions);
    }
    public ViewInteractionSuper perform(boolean isTry , final ViewAction... viewActions) {
        if(isTry){
            try {
     ...
     * @return
     */
    public ViewInteractionSuper click(){
     ...
     * @return
     */
    public ViewInteractionSuper check(final int times , final ViewAssertion viewAssert){
        for(int i=1; i<times ; i++){
     ...
     * @return
     */
    public ViewInteractionSuper check(final ViewAssertion viewAssert){
        return check(5 , viewAssert);
    }

    public ViewInteractionSuper check(boolean isTry , final ViewAssertion viewAssert){
        if(isTry){
            try {
     ...
     * @return
     */
    public ViewInteractionSuper pause(long time){
        try {
            Thread.sleep(time);
